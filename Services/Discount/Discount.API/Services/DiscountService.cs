...
namespace Discount.API.Services
{
    public class DiscountService : DiscountProtoService.DiscountProtoServiceBase
    {
        ...
        public ILogger<DiscountService> _logger;
        public readonly ICorrelationIdGenerator _correlationIdGenerator;
        ...
        )
        {
            ...
            _logger.LogInformation(
                $"Discount is successfully created for the Product Name: {result.ProductName}"
            );
            return result;
        }
        ...
        )
        {
            ...
            var result = await _mediator.Send(cmd);
            _logger.LogInformation(
                $"Discount is successfully updated for the Product Name: {result.ProductName}"
            );
            return result;
        }
